...
//func (sk *p11EcdsaPrivateKey) Public() crypto.PublicKey {
//	return sk.pubKey.ToStandardKey()
//}

// SKI returns the subject key identifier of this key.
func (sk *p11EcdsaPrivateKey) SKI() (ski []byte) {
	pubKey :=sk.pubKey
	if pubKey == nil {
		return nil
	}
...
func (sk *p11EcdsaPrivateKey) Public() bccrypto.PublicKey {
	return sk.pubKey
}
